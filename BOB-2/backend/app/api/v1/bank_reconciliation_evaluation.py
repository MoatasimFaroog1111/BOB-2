...
from app.services.bank_reconciliation_evaluation import BankReconciliationEvaluationService
...
def evaluate_bank_reconciliation_predictions(
    ...
    """Run a leakage-safe time-series evaluation against posted Odoo history.

    This endpoint is read-only. It does not create, edit, reconcile, draft, post,
    or otherwise mutate ERP records.
    """
