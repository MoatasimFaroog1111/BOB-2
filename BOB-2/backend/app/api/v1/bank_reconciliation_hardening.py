...
def _build_result_payload(
    *,
    ...
    return {
        ...
        "warning": warning,
        "historical_suggestion_summary": {
            "method": "deferred_to_dedicated_endpoint",
            "safe_to_post": False,
            "note": (
                "Historical Odoo account/partner/analytic enrichment is loaded separately "
                "through /bank-reconciliation/entry-suggestions after the core reconciliation response."
            ),
        },
        "safe_to_post": False,
