...
def main() -> None:
    ...
    require("login refresh token starts at generation zero", "rotation_generation=0" in auth_api)
    ...
    require("session creation is audited", 'event_type="session_created"' in auth_api)
